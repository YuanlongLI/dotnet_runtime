...
namespace System.Text.Json.Serialization
{
    ...
    public abstract class JsonConverter<T> : JsonConverter
    {
        ...
        {
            // For performance and converter implementation simplicity, handle null here instead of forwarding to the converter.
            if (reader.TokenType == JsonTokenType.Null && !HandleNullValue && !state.IsContinuation)
            {
                value = default!;
                return true;
            }
